...
export default function ExistBookings() {
   ...
   const TokenUser= JSON.parse(localStorage.getItem("token-user"))
    ...
    useEffect(()=>{
     ...
     fetch(`https://car-rental-7mti.onrender.com/orders/${userId}`)
    ...
    function deleteCarData(id){
        ...
        fetch(`https://car-rental-7mti.onrender.com/orders/${id}`, {
                    ...
                    <div id="outer">
                        ...
                        <div className="bookings">
                            <div id="myimg" className="smallerDiv" >
                                <img src={`https://car-rental-7mti.onrender.com/cars/${d.image}`} width="250px" />
                            </div>
