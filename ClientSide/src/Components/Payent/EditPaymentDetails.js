...
//    console.log(EditPaymentDetails)
   EditPaymentDetails.MapImg=headerData.MapImg
    function editformsubmitFunc(e){
        ...
        fetch(`https://car-rental-7mti.onrender.com/orders/${EditPaymentDetails._id}` , {
...
<form onSubmit={editformsubmitFunc} id="Edit-form-payment-details">
    ...
    <img src={`https://car-rental-7mti.onrender.com/cars/${image}`} id="image-edit-payment-details-in-data"></img>
